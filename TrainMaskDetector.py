# python TrainMaskDetector.py --dataset dataset
...
for imgPath in imgPaths:
	label = imgPath.split(os.path.sep)[-2] #extract class label from filename
	image = preprocess_input(img_to_array(load_img(imgPath, target_size=(224, 224))))
	data.append(image)
	labels.append(label)
...
# compiling model through adam
print("compiling model...")
optimizer = Adam(lr=INIT_LR, decay=INIT_LR / EPOCHS) #stochastic gradient descent
